...
export const MobileProfile: React.FC<MobileProfileProps> = ({ onSignOut }) => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Actions */}
      <div className="space-y-3">
        <button className="w-full flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
        ...
        <button
          onClick={onSignOut}
          className="w-full flex items-center space-x-3 p-4 bg-red-50 rounded-xl hover:bg-red-100 transition-colors duration-200 text-red-600"
        >
